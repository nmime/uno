...
const Button = ({ icon, label, onClick }: ButtonProps) => (
  <button
    type="button"
    className="inline-flex items-center rounded-lg p-2 text-sm font-medium text-[--button-text-color] hover:bg-[--button-color-light] focus:bg-[--button-color-light] focus:outline-none"
    onClick={onClick}
  >
