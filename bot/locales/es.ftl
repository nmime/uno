...
start = 👋 Bienvenido a <b>UNO!</b>
    ...
    .profile = 💼 Perfil
uno = ¡Abierta la inscripción para UNO!

    🕹 Para unirte al juego, pulsa el botón de abajo.
    .key = ¡Jugar! 🚀
profile = <b>🌟 Tu perfil 🌟</b>
    ...
    <b>🔗 Tu enlace de referencia</b>: <code>{ $referralLink }</code>
    .key = Abrir perfil
...
statistics = <b>📊 Estadísticas</b>
    ...
    <b>Nuevos usuarios:</b> <i>(total / vivos / sin referidos)</i>
    ...
    <b>En juego actualmente</b>: {$gameNow}
...
adRef = <b>{$name}</b>
    ...
    <b>Usuarios vivos</b>: {$aliveCounter} ({$aliveCounterPercent}%)
