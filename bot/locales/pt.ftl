...
start = 👋 Bem-vindo ao <b>UNO!</b>
    ...
    Junte-se ao jogo ou adicione ao grupo e desfrute do lendário UNO!
    .openWebApp = Jogar! 🚀
    .addGroup = Adicionar ao grupo
    .profile = 💼 Perfil
uno = Aberta a inscrição no jogo UNO!

    🕹 Para se juntar ao jogo, clique no botão abaixo.
    .key = Jogar! 🚀
profile = <b>🌟 Seu perfil 🌟</b>
    ...
    <b>👥 Número de indicações</b>: { $referralCounter }
    <b>🎁 Bônus de indicação</b>: { $referralAccrual } 💰 (<i>concedido após um jogo jogado</i>)
    <b>🔗 Seu link de indicação</b>: <code>{ $referralLink }</code>
    .key = Abrir perfil
language = 🏳️ Escolher idioma
...
statistics = <b>📊 Estatísticas</b>
    ...
    <b>Sem indicações</b>: {$withoutRef} ({$withoutRefPercent}%)

    <b>DAU</b>: {$dau} ({$dauPercent}%)  <b>YAU</b>: {$yau} ({$yauPercent}%)
    <b>WAU</b>: {$wau} ({$wauPercent}%)  <b>MAU</b>: {$mau} ({$mauPercent}%)

    <b>Novos usuários:</b> <i>(total / vivos / sem indicações)</i>
...
adRef = <b>{$name}</b>
    ...
    <b>Jogos ganhos e perdidos</b>: {$gameWin} & {$gameLose} <i>os jogos não são únicos</i>
